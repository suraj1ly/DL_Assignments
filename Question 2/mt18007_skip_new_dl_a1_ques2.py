# -*- coding: utf-8 -*-
"""MT18007_Skip_New_DL_A1_Ques2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1cRZbqIV30xHMDSOUEc_Stql68phrYmif
"""
...
class segnet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # print("up5", up5.shape)
        temp1 = torch.cat([up5, c4], dim=1)
        up4 = self.up4(temp1)
        # up4 = self.up4(up5)
        # print("up4", up4.shape)
        up3 = self.up3(up4, indices_3, unpool_shape3)
        # print("up3", up3.shape)
        temp2 = torch.cat([up3, c2], dim=1)
        up2 = self.up2(temp2)
        # up2 = self.up2(up3)
        # print("up2", up2.shape)
...
num_epochs = 20
pth = '/content/drive/My Drive/Colab Notebooks/DL_SkipModels_A1Q2_v1/'
k = 0
lossArr = []
accArrTrain = []
accArrVal = []
